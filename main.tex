...
\setbeamertemplate{bibliography item}{[\printfield{labelnumber}]}
\input{Settings/fontsetting} % font configuration
\input{Settings/initialization} %title page configuration
